...
<body class="antialiased font-sans bg-slate-50 dark:bg-slate-900">
    ...
    <div class="fixed inset-0 overflow-hidden -z-10">
        <div class="absolute w-[500px] h-[500px] bg-sky-400/30 rounded-full blur-3xl top-[-100px] left-[-200px] animate-spin-slow"></div>
        <div class="absolute w-[600px] h-[600px] bg-emerald-400/20 rounded-full blur-3xl bottom-[-200px] right-[-200px] animate-spin-slow"></div>
    </div>
    ...
    <div class="relative min-h-screen">
            ...
            <nav class="flex items-center justify-between mx-auto max-w-7xl">
                ...
                <div class="flex items-center gap-4">
                    @if (Route::has('login'))
                        <div class="flex items-center gap-4">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="px-4 py-2 font-medium text-slate-700 hover:text-slate-900 dark:text-slate-200 dark:hover:text-white">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}" class="px-4 py-2 font-medium text-slate-700 hover:text-slate-900 dark:text-slate-200 dark:hover:text-white border border-slate-200 dark:border-slate-700 rounded-lg">Log in</a>
                                
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="px-4 py-2 rounded-lg bg-gradient-custom text-white font-medium shadow-md hover:shadow-lg transition-all">Register</a>
                                @endif
                            @endauth
                        </div>
                    @endif
        ...
        <main class="relative overflow-hidden">
                ...
                <div class="mx-auto max-w-7xl">
                    <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                        <div class="lg:col-span-6 px-0 sm:px-6 flex flex-col justify-center">
                            <div>
                                <h1 class="text-4xl font-bold tracking-tight text-slate-800 dark:text-white sm:text-5xl md:text-6xl">
                                    <span class="text-gradient">TrackWise</span>
                                </h1>
                                <p class="mt-6 text-lg text-slate-600 dark:text-slate-300">
                                    TrackWise provides powerful expense monitoring and tracking tools to help you manage your finances, track spending, and improve budgeting.
                                </p>
                                <div class="mt-10 flex gap-4">
                                    <a href="#features" class="px-6 py-3 rounded-lg bg-gradient-custom text-white font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all">
                                        Get Started
                                    </a>
                                </div>
                                </div>
                        ...
                        <div class="mt-12 lg:mt-0 lg:col-span-6 relative">
                            ...
                            <div class="relative h-[500px] w-full flex items-center justify-center">
                                <div class="absolute z-10 w-72 h-60 bg-white dark:bg-slate-800 rounded-xl shadow-2xl p-4 transform rotate-3 animate-float">
                                ...
                                <div class="absolute z-20 w-64 h-56 bg-white dark:bg-slate-800 rounded-xl shadow-2xl p-4 top-40 right-10 transform -rotate-6 animate-float-delay-1">
                                    <div class="h-4 w-16 bg-emerald-200 dark:bg-emerald-900 rounded mb-4"></div>
                                    <div class="h-16 w-full bg-slate-200 dark:bg-slate-700 rounded-lg flex items-center justify-center">
                                ...
                                <div class="absolute z-0 w-56 h-52 bg-white dark:bg-slate-800 rounded-xl shadow-2xl p-4 bottom-10 left-10 transform rotate-12 animate-float-delay-2">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl text-center">
                        ...
                        <p class="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-300 reveal">
                            TrackWise offers comprehensive tools to manage your finances and gain insights into your spending habits.
                        </p>
                    </div>
                    
                    <div class="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <!-- Feature 1 -->
                        <div class="flex flex-col rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300 reveal">
                            ...
                            <p class="mt-4 flex-1 text-slate-600 dark:text-slate-300">
                                Record and categorize your expenses with ease. Track every transaction with date, category, and payment method.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300 reveal">
                            ...
                            <p class="mt-4 flex-1 text-slate-600 dark:text-slate-300">
                                Monitor all your income sources in one place. Easily record salary, freelance work, investments, and other revenue streams.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300 reveal">
                            ...
                            <p class="mt-4 flex-1 text-slate-600 dark:text-slate-300">
                                Visualize your spending patterns with simple charts and identify opportunities to save with our intuitive dashboard.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-24 mb-24 reveal">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl rounded-2xl bg-gradient-custom p-10 text-center text-white shadow-xl">
                        ...
                        <div class="mt-8">
                            <a href="#" class="inline-block rounded-lg bg-white px-6 py-3 text-base font-medium text-sky-600 shadow-sm hover:bg-slate-50 transition-all transform hover:-translate-y-1">
                                Start Free Trial
                            </a>
                        </div>
                    </div>
