        ...
        <div class="flex-1 overflow-y-auto md:pt-4 pt-4 px-6 bg-base-200">
            <div class="card w-full p-6 bg-base-100 shadow-xl mt-2">
                @if ($accounts)
                    ...
                    <div class="bg-gradient-to-r from-info/20 to-info/5 rounded-xl p-4 mb-6 shadow-sm flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="bg-info/30 p-2.5 rounded-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
                                     stroke="currentColor" class="size-6 text-info-content">
                                    <path stroke-linecap="round" stroke-linejoin="round" 
                                          d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                                </svg>
                            </div>
                            <div>
                                <h2 class="text-sm font-medium text-info-content/70">Total Balance</h2>
                                <p class="text-xl font-bold text-info-content">₱{{ number_format($totalBalance) }}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($records as $account)
                                <li class="group list-row hover:bg-base-200 flex items-center justify-between w-full px-5 py-4 border border-base-200 rounded-xl mb-3 mx-0.5 transition-all duration-200 hover:shadow-md cursor-pointer"
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p class="text-lg font-bold group-hover:text-primary transition-colors duration-200">{{ $account['name'] }}</p>
                                        </div>
                                    </div>

                                    <div>
                                        <div class="text-sm uppercase font-semibold badge badge-lg whitespace-nowrap badge-primary text-white">
