        ...
        <div class="flex-1 overflow-y-auto md:pt-4 pt-4 px-6 bg-base-200">
            <div class="card w-full p-6 bg-base-100 shadow-xl mt-2">
                @if ($accounts)
                    ...
                    <div
                        class="bg-gradient-to-r from-info/20 to-info/5 rounded-xl p-4 mb-6 shadow-sm flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="bg-info/30 p-2.5 rounded-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6 text-info-content">
                        ...
                        @foreach ($accounts as $categoryName => $records)
                            ...
                            @foreach ($records as $account)
                                <li class="group list-row hover:bg-base-200 flex items-center justify-between w-full px-5 py-4 border border-base-200 rounded-xl mb-3 mx-0.5 transition-all duration-200 hover:shadow-md cursor-pointer"
                                    ...
                                    <div>
                                        <div
                                            class="text-sm uppercase font-semibold badge badge-lg whitespace-nowrap badge-primary text-white">
